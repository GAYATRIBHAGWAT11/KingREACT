            ...
            <header className="header header-light">
                <div className="container container-light" >
                    <nav className="navbar">
                        <h1>
                            <Link rel="stylesheet" className="brand brand-light" to='/'>News App</Link>
                        ...
                        <form onSubmit={(e)=>changeUrl(e,value)}>
                            <div className="search">
                                <input type="text"  className='search-item search-term-light' placeholder='Search News' onChange={handleChange}/>
                                <button type='submit' className='search-button search-button-light'>
